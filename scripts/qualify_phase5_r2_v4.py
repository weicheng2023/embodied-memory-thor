...
QUALIFICATION_VERSION = "phase5-r2-native-qualification-v4"
SCRIPT_VERSION = "phase5-r2-qualification-stable-visual-v4"
BOUNDARY = "EVALUATOR-ONLY R2 V4 QUALIFICATION - NEVER PLANNER INPUT"
CONTROLLER_SETTINGS = {
    "width": 300,
    "height": 300,
    "quality": "Low",
...
def build_public_summary(
    *,
    ...
    return {
        ...
        "standing_pose_count": len(stability_audit),
